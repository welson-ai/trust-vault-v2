...
export function ContractParticipants({ formData, setFormData }: any) {
  ...
  const [role, setRole] = useState<"freelancer" | "client" | "member" | "buyer" | "seller">("freelancer")
    ...
    switch (formData.type) {
      ...
      case "chama":
        return [
          ...
          { value: "client", label: "Administrator" },
        ]
      case "purchase":
        return [
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mb-4">
          {formData.type === "freelance" && "Search and add team members and clients"}
          {formData.type === "chama" && "Add group members who will contribute to the savings pool"}
          {formData.type === "purchase" && "Add the buyer and seller for this transaction"}
        </p>
